const fr = {
  ...
  topbar: {
    ...
    myCurrentSchedule: 'Mon Planning Actuel',
  ...
  classes: {
    ...
    noLevels: 'Aucun niveau d\'étude défini pour ce département.',
  ...
  teacher: {
    ...
    historyDeleted: 'Historique des absences effacé',
    allUpToDate: 'Toutes les absences sont à jour.',
    historyDesc: 'Consulter et gérer les anciens enregistrements d\'absences.',
    justifyDesc: 'Fournir des justifications pour les absences signalées.',
    reasonPlaceholder: 'Motif de l\'absence...',
    communicationsFromHR: 'Communications des RH et du département',
    manageInboxDesc: 'Consultez les annonces officielles et les messages administratifs.',
    ...
    official: 'Officiel',
    noRemindersTitle: 'Boîte de réception vide',
  ...
  absences: {
    ...
    justify: 'Justifier',
    updateJustification: 'Mettre à jour',
    cancelJustification: 'Annuler la justification',
    confirmCancelJustify: 'Voulez-vous vraiment annuler votre justification ?',
    justificationCancelled: 'Justification annulée',
    catchUp: 'Rattraper',
  ...
  departments: {
    ...
    errorDeleting: 'Erreur lors de la suppression',
    manageTitle: 'Gestion des Départements',
    addNew: 'Ajouter un Nouveau Département',
  ...
  documents: {
    ...
    selectDocType: 'Choisir le type...',
    workCert: 'Attestation de travail',
    salarySlip: 'Fiche de paie / Attestation de salaire',
    teachingLoad: 'Attestation de charge horaire',
    missionOrder: 'Ordre de mission',
    leaveRequest: 'Demande de congé',
    adminCert: 'Certificat administratif',
    pending: 'En attente de soumission',
    headApproved: 'Approuvé par le Chef de Dept',
    processing: 'Traitement par les RH',
    hrApproved: 'Validé par les RH',
    signed: 'Signé Officiellement',
    available: 'Disponible pour retrait',
    rejected: 'Demande Rejetée',
    submitRequest: 'Soumettre la demande',
    confirmReceipt: 'Confirmer la récupération',
    ...
    manageTitle: 'Gestion des Demandes de Documents',
    processingInstruction: 'Entrez une note pour le demandeur (optionnel)...',
    notePlaceholder: 'Votre note administrative ici...',
    processRequest: 'Traiter la demande',
  ...
  evaluations: {
    ...
    manageTitle: 'Suivi des Évaluations des Enseignants',
  },
  ...
  promotions: {
    ...
    statusHeadApproved: 'Approuvé par Chef Dépt',
    statusPreValidated: 'Pré-validé (Vice-Doyen)',
    statusDeanValidated: 'Validé par le Doyen',
    statusHRProcessed: 'Traité par RH',
    statusViceRectorApproved: 'Approuvé par Vice-Recteur',
  ...
  reminders: {
    ...
    manageTitle: 'Système Global de Rappels',
    scope: '1. Portée de la Diffusion',
    allFaculty: 'Tout le Personnel Enseignant',
    deptHeads: 'Tous les Chefs de Département',
    priority: '2. Niveau de Priorité',
    typeInfo: 'Information (Neutre)',
    typeWarning: 'Important / Avertissement',
    typeUrgent: 'Alerte Urgente',
    typeOfficial: 'Note Administrative Officielle',
    selectRecipient: '3. Sélectionner un Destinataire Spécifique',
    messageContent: '4. Contenu du Message',
    officialPlaceholder: 'Texte de l\'annonce officielle ici...',
  ...
  salary: {
    ...
    hourlyRate: 'Taux par séance supp (DA)',
    absencePenalty: 'Pénalité d\'absence (DA)',
    currentMonth: 'Situation Salariale Actuelle',
    extraPay: 'Gain Séances Supp.',
    ...
    manageTitle: 'Gestion de la Paie et des Salaires',
    noAbsences: 'Aucune absence enregistrée ce mois-ci.',
    noExtraSessions: 'Aucune séance supplémentaire enregistrée ce mois-ci.',
  },

  // ── Gestion des séances ──
  sessions: {
    addSession: 'Ajouter une nouvelle séance',
    ...
    successCancel: 'Séance annulée avec succès',
    newSession: 'Nouvelle Séance Académique',
    newSessionDesc: 'Programmer un nouveau créneau d\'enseignement dans le calendrier académique.',
    moduleName: 'Nom du Module',
    filterDept: 'Filtrer par Département',
    listTitle: 'Emploi du Temps Académique Hebdomadaire',
    countLabel: 'Total des Séances :',
    empty: 'Aucune séance trouvée pour cette sélection.',
    successAdd: 'Séance ajoutée avec succès',
