const en = {
  ...
  absences: {
    ...
    justify: 'Justify',
    updateJustification: 'Update Submission',
    cancelJustification: 'Cancel Justification',
    confirmCancelJustify: 'Are you sure you want to cancel your justification?',
    justificationCancelled: 'Justification cancelled',
    catchUp: 'Catch Up',
  ...
  documents: {
    ...
    salarySlip: 'Salary Certificate',
    teachingLoad: 'Teaching Load Certificate',
    missionOrder: 'Mission Order',
    leaveRequest: 'Leave Request',
    adminCert: 'Administrative Certificate',
    
    pending: 'Pending Submission',
    headApproved: 'Approved by Department Head',
    processing: 'Processing by HR',
    hrApproved: 'Validated by HR',
    signed: 'Officially Signed',
    available: 'Available for Collection',
    rejected: 'Request Rejected',
    
    submitRequest: 'Submit Request',
    confirmReceipt: 'Confirm Collection',
  ...
  promotions: {
    ...
    statusHeadApproved: 'Head Approved',
    statusPreValidated: 'Pre-validated',
    statusDeanValidated: 'Dean Validated',
    statusHRProcessed: 'HR Processed',
    statusViceRectorApproved: 'Vice Rector Approved',
